...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557687 = false;
    F.line = 31;
    var item_33557688 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557687 = item_33557688 !== undefined;
    if (tmp_33557687) {
    F.line = 34;
    result_33557686 = nimCopy(null, makeNimstrLit(item_33557688.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557686 = nimCopy(null, (HEX24__systemZdollars_u14(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557686;
